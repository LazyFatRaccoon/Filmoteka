function t(t,e,n,r){Object.defineProperty(t,e,{get:n,set:r,enumerable:!0,configurable:!0})}var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{};function n(t){return t&&t.__esModule?t.default:t}var r={},i={},s=e.parcelRequired76b;null==s&&((s=function(t){if(t in r)return r[t].exports;if(t in i){var e=i[t];delete i[t];var n={id:t,exports:{}};return r[t]=n,e.call(n.exports,n,n.exports),n.exports}var s=new Error("Cannot find module '"+t+"'");throw s.code="MODULE_NOT_FOUND",s}).register=function(t,e){i[t]=e},e.parcelRequired76b=s),s.register("gitjG",(function(e,n){t(e.exports,"scrollTopTop",(function(){return i}));const r=document.querySelector(".back-to-top");function i(){window.scrollTo({top:0,behavior:"smooth"})}window.addEventListener("scroll",(function(){document.querySelector(".back-to-top").classList.toggle("active",window.scrollY>500)})),r.addEventListener("click",i)})),s.register("dzieU",(function(e,n){t(e.exports,"refs",(function(){return a})),s("83ZX7");var r=s("5rhw3"),i=s("l7Vfm"),o=s("2iIDe");const a={img:document.querySelector(".modal__preview-img"),discTitle:document.querySelector(".discription__title"),rait:document.querySelector(".mvi__rait"),watch:document.querySelector(".mvi__watch"),pop:document.querySelector(".mvi__pop"),mviName:document.querySelector(".mvi__name"),mviGenre:document.querySelector(".mvi__genre"),discText:document.querySelector(".discription__about-text"),backdrop:document.querySelector(".backdrop"),body:document.querySelector("body"),gallery:document.querySelector(".films__list"),btnW:document.querySelector(".add-btn__watched"),btnQ:document.querySelector(".add-btn__queue"),closeBtn:document.querySelector(".modal__close-btn")};a.gallery.addEventListener("click",(function(t){(0,o.notiflixLoading)();const e=t.path.filter((t=>"LI"===t.nodeName))[0];c=e.dataset.id,n=c,async function(t){const e="https://image.tmdb.org/t/p/w500",n=await r.default.getMovieById(t),{original_title:s,poster_path:o,vote_average:u,vote_count:l,popularity:h,overview:f}=n,d=n.genres.reduce(((t,e)=>[...t,e.name]),[]);a.img.setAttribute("src",`${e+o}`),a.btnW.setAttribute("id",c),a.btnQ.setAttribute("id",c),a.discTitle.innerHTML=`${s}`,a.rait.innerHTML=`${u.toFixed(2)}`,a.watch.innerHTML=`${l}`,a.pop.innerHTML=`${h.toFixed(1)}`,a.mviName.innerHTML=`${s}`,a.mviGenre.innerHTML=`${d.join(", ")}`,a.discText.innerHTML=`${f}`,function(t){const e=function(t){const e=(0,i.loadList)("moveList");console.log(t),console.log(e);let n=-1;for(let r=0;r<e.length&&(n=r,Number(e[r].id)!==Number(t));r+=1)n=-1;console.log(n);const r=!(n<0)&&e[n].watched,s=!(n<0)&&e[n].queque;return{watched:r,queque:s}}(t);console.log(e);const n=e.watched?"remove from watched":"add to watched",r=e.watched?"disabl":"y",s=e.queque?"remove from queque":"add to queue",o=e.queque?"disabl":"y";a.btnW.innerHTML=`${n}`,a.btnW.classList.add(r),a.btnQ.innerHTML=`${s}`,a.btnQ.classList.add(o)}(t)}(n),a.backdrop.classList.remove("isHidden"),a.body.classList.add("scroll"),document.addEventListener("keydown",u),(0,o.notiflixLoadingRemove)();var n})),a.closeBtn.addEventListener("click",l),a.backdrop.addEventListener("click",(function(t){t.currentTarget===t.target&&l()}));let c=0;function u(t){"Escape"===t.code&&l()}function l(){a.backdrop.classList.add("isHidden"),a.body.classList.remove("scroll"),a.img.removeAttribute("src"),a.btnW.removeAttribute("id"),a.btnQ.removeAttribute("id"),a.discTitle.innerHTML="",a.rait.innerHTML="",a.watch.innerHTML="",a.pop.innerHTML="",a.mviName.innerHTML="",a.mviGenre.innerHTML="",a.discText.innerHTML="",a.btnW.innerHTML="",a.btnW.classList.remove("disabl"),a.btnQ.innerHTML="",a.btnQ.classList.remove("disabl")}})),s.register("83ZX7",(function(e,n){t(e.exports,"getFirestore",(function(){return s("3PjDZ").getFirestore})),t(e.exports,"getDoc",(function(){return s("3PjDZ").getDoc})),t(e.exports,"doc",(function(){return s("3PjDZ").doc})),t(e.exports,"updateDoc",(function(){return s("3PjDZ").updateDoc})),t(e.exports,"arrayUnion",(function(){return s("3PjDZ").arrayUnion})),t(e.exports,"arrayRemove",(function(){return s("3PjDZ").arrayRemove})),t(e.exports,"setDoc",(function(){return s("3PjDZ").setDoc})),s("3PjDZ")})),s.register("3PjDZ",(function(e,n){t(e.exports,"doc",(function(){return Us})),t(e.exports,"getFirestore",(function(){return js})),t(e.exports,"getDoc",(function(){return xo})),t(e.exports,"setDoc",(function(){return Ao})),t(e.exports,"updateDoc",(function(){return ko})),t(e.exports,"arrayUnion",(function(){return Lo})),t(e.exports,"arrayRemove",(function(){return Oo}));var r=s("ix4Jr"),i=s("4a6xH"),o=s("7vF8m"),a=s("ffjl9"),c=s("lW9Fu");s("4TNnu");const u="@firebase/firestore";
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ie{constructor(){this._=void 0}}function xe(t,e,n){return t instanceof ke?Ne(t,e):t instanceof De?Le(t,e):n}function Ce(t,e){var n,r;return t instanceof Oe?Nt(n=e)||(r=n)&&"doubleValue"in r?e:{integerValue:0}:null}class Ae extends Ie{}class ke extends Ie{constructor(t){super(),this.elements=t}}function Ne(t,e){const n=Me(e);for(const e of t.elements)n.some((t=>St(t,e)))||n.push(e);return{arrayValue:{values:n}}}class De extends Ie{constructor(t){super(),this.elements=t}}function Le(t,e){let n=Me(e);for(const e of t.elements)n=n.filter((t=>!St(t,e)));return{arrayValue:{values:n}}}class Oe extends Ie{constructor(t,e){super(),this.wt=t,this._t=e}}function Re(t){return ft(t.integerValue||t.doubleValue)}function Me(t){return Dt(t)&&t.arrayValue.values?t.arrayValue.values.slice():[]}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ks(t,e,n){if(!n)throw new T(E.INVALID_ARGUMENT,`Function ${t}() cannot be called with an empty ${e}.`)}function Ns(t){if(!j.isDocumentKey(t))throw new T(E.INVALID_ARGUMENT,`Invalid document reference. Document references must have an even number of segments, but ${t} has ${t.length}.`)}function Ds(t){if(void 0===t)return"undefined";if(null===t)return"null";if("string"==typeof t)return t.length>20&&(t=`${t.substring(0,20)}...`),JSON.stringify(t);if("number"==typeof t||"boolean"==typeof t)return""+t;if("object"==typeof t){if(t instanceof Array)return"an array";{const n=(e=t).constructor?e.constructor.name:null;return n?`a custom ${n} object`:"an object"}}var e;return"function"==typeof t?"a function":v()}function Ls(t,e){if("_delegate"in t&&(t=t._delegate),!(t instanceof e)){if(e.name===t.constructor.name)throw new T(E.INVALID_ARGUMENT,"Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");{const n=Ds(t);throw new T(E.INVALID_ARGUMENT,`Expected type '${e.name}', but it was: ${n}`)}}return t}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function xo(t){t=Ls(t,Ms);const e=Ls(t.firestore,Vs);return Cs(qs(e),t._key).then((n=>Do(e,t,n)))}class Co extends So{convertBytes(t){return new Hs(t)}convertReference(t){const e=this.convertDocumentKey(t,this.firestore._databaseId);return new Ms(this.firestore,null,e)}constructor(t){super(),this.firestore=t}}function Ao(t,e,n){t=Ls(t,Ms);const r=Ls(t.firestore,Vs),i=Io(t.converter,e,n);return No(r,[eo(to(r),"setDoc",t._key,i,null!==t.converter,n).toMutation(t._key,Ue.none())])}function ko(t,e,n,...r){t=Ls(t,Ms);const i=Ls(t.firestore,Vs),s=to(i);let o;return o="string"==typeof(e=(0,a.getModularInstance)(e))||e instanceof zs?ao(s,"updateDoc",t._key,e,n,r):oo(s,"updateDoc",t._key,e),No(i,[o.toMutation(t._key,Ue.exists(!0))])}function No(t,e){return function(t,e){const n=new _;return t.asyncQueue.enqueueAndForget((async()=>async function(t,e,n){const r=ms(t);try{const t=await function(t,e){const n=b(t),r=M.now(),i=e.reduce(((t,e)=>t.add(e.key)),mn());let s,o;return n.persistence.runTransaction("Locally write mutations","readwrite",(t=>{let a=an(),c=mn();return n.Ui.getEntries(t,i).next((t=>{a=t,a.forEach(((t,e)=>{e.isValidDocument()||(c=c.add(t))}))})).next((()=>n.localDocuments.getOverlayedDocuments(t,a))).next((i=>{s=i;const o=[];for(const t of e){const e=ze(t,s.get(t.key).overlayedDocument);null!=e&&o.push(new Ke(t.key,e,Ut(e.value.mapValue),Ue.exists(!0)))}return n.mutationQueue.addMutationBatch(t,r,o,e)})).next((e=>{o=e;const r=e.applyToLocalDocumentSet(s,c);return n.documentOverlayCache.saveOverlays(t,e.batchId,r)}))})).then((()=>({batchId:o.batchId,changes:ln(s)})))}(r.localStore,e);r.sharedClientState.addPendingMutation(t.batchId),function(t,e,n){let r=t.oc[t.currentUser.toKey()];r||(r=new nt(O)),r=r.insert(e,n),t.oc[t.currentUser.toKey()]=r}(r,t.batchId,n),await fs(r,t.changes),await wi(r.remoteStore)}catch(t){const e=Oi(t,"Failed to persist write");n.reject(e)}}(await Is(t),e,n))),n.promise}(qs(t),e)}function Do(t,e,n){const r=n.docs.get(e._key),i=new Co(t);return new To(t,i,e._key,r,new Eo(n.hasPendingWrites,n.fromCache),e.converter)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const C="firebase-heartbeat-store";let A=null;function k(){return A||(A=(0,a.openDB)("firebase-heartbeat-database",1,{upgrade:(t,e)=>{if(0===e)t.createObjectStore(C)}}).catch((t=>{throw E.create("idb-open",{originalErrorMessage:t.message})}))),A}async function N(t,e){var n;try{const n=(await k()).transaction(C,"readwrite"),r=n.objectStore(C);return await r.put(e,D(t)),n.done}catch(t){if(t instanceof o.FirebaseError)h.warn(t.message);else{const e=E.create("idb-set",{originalErrorMessage:null===(n=t)||void 0===n?void 0:n.message});h.warn(e.message)}}}function D(t){return`${t.name}!${t.options.appId}`}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
function L(t){return t&&t._delegate?t._delegate:t}})),s.register("7vF8m",(function(e,n){t(e.exports,"LogLevel",(function(){return i})),t(e.exports,"Logger",(function(){return l})),t(e.exports,"setLogLevel",(function(){return h})),t(e.exports,"setUserLogHandler",(function(){return f}));
/**
 * @license
 * Copyright 2017 Google LLC
 *
