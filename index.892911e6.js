 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function be(t){const e=t.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Ie(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(we(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Te(e))return"Blackberry";if(Ee(e))return"Webos";if(xe(e))return"Safari";if((e.includes("chrome/")||ke(e))&&!e.includes("edge/"))return"Chrome";if(Ne(e))return"Android";{const e=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,i=t.match(e);if(2===(null==i?void 0:i.length))return i[1]}return"Other"}function we(t=m()){return/firefox\//i.test(t)}function xe(t=m()){const e=t.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function ke(t=m()){return/crios\//i.test(t)}function Ie(t=m()){return/iemobile/i.test(t)}function Ne(t=m()){return/android/i.test(t)}function Te(t=m()){return/blackberry/i.test(t)}function Ee(t=m()){return/webos/i.test(t)}function _e(t=m()){return/iphone|ipad|ipod/i.test(t)||/macintosh/i.test(t)&&/mobile/i.test(t)}function Se(t=m()){return _e(t)||Ne(t)||Ee(t)||Te(t)||/windows phone/i.test(t)||Ie(t)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
